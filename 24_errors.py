...
#A continuación, se meustran varias formas de capturar errores
try:
    print(0/0)
...
#No es necesario crear un try para cada uno. Se puede colocar todo en uno
#En cuanto detecta un error, no sigue ejecutando el código de try
#Continúa con el que viene después.
try:
    print(0/0)
    assert 1 != 1, 'Uno no es igual que uno'
    age = 10
